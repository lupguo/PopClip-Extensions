...
const auth = async (info, flow) => {
    ...
    const { data: { client_id, client_secret } } = await instance.post("/api/v1/apps", {
        client_name: "PopClip",
...
const follow = async (input, options) => {
    ...
    const id = (_a = accounts.find((account) => account.acct === accountToFollow)) === null || _a === void 0 ? void 0 : _a.id;
    if (!id)
